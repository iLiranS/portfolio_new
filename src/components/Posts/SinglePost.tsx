...
const SinglePost:React.FC<{post:Post,isLatest?:boolean}> = ({post,isLatest=false}) =>{
    ...
    return(
        <li  className='grid items-center grid-rows-2 p-2 rounded-md cursor-pointer
        ...
        dark:bg-lightBG dark:bg-opacity-10'>
            <section className={`grid grid-cols-[auto,max-content] max-[360px]:grid-cols-1 max-[360px]:grid-flow-row justify-between items-center gap-2 w-full`}>
